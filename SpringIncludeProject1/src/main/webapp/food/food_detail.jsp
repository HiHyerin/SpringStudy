...
<body>
	...
	<div class="row">
					  	  ...
					  	  <tr>
					  	  	...
					  	  	<td class="text-right">
					  	  		<c:if test = "${sessionScope.id == rvo.id }">
					  	  			...
					  	  			<a href="../reply/delete.do?no=${rvo.no }&rno=${vo.fno}&type=1" class="btn btn-xs btn-danger">삭제</a>
					  	  		</c:if>
					  	  	</td>
					  	  </tr>
					  	  <tr>
		...
		<div class="col-sm-4">
			...
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=474ea1f30b292f1e0644ae92fbff2778&libraries=services"></script>
			<script>
				// 마커를 담을 배열입니다
				var markers = [];
